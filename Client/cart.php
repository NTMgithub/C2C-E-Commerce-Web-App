                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="product-price"><span class="amount">100.000 VNĐ</span></td>
                                            <td class="product-quantity"><input type="number" value="1" min="0"/></td> <!--Nếu muốn nó = 0 thì xóa cho nhanh :))-->
                                            <td class="product-subtotal">100.000 VNĐ</td>
                                        ...
                                        <table class="float-md-right">
                                            <tbody>
                                                ...
                                                <tr class="order-total">
                                                    <th>Phụ Thu</th>
                                                    <td>
                                                        <strong><span class="amount">50.000 VNĐ</span></strong>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
