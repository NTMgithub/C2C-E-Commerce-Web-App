...
<head>
    ...
    <title>Quên mật khẩu | Web C2C</title>
            ...
            <div class="container">
                <div class="breadcrumb">
                    <ul class="d-flex align-items-center">
                        ...
                        <li class="active"><a href="forgot-password.php">Quên Mật Khẩu</a></li>
                    </ul>
                </div>
            </div>
            <!-- Container End -->
                ...
                <form class="password-forgot clearfix" action="mail.php">
                    ...
                    <div class="buttons newsletter-input">
                        <div class="float-left float-sm-left">
                            <a class="customer-btn mr-20" href="login.php">Trở về</a>
                        </div>
                        <div class="float-right float-sm-right">
                            <input type="submit" value="Khôi phục mật khẩu" class="return-customer-btn">
                        </div>
                    </div>
                </form>
            </div>
