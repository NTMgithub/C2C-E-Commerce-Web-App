            ...
            <div class="container">
                <div class="d-flex flex-wrap text-center">
                    ...
                    <div class="single-support">
                        ...
                        <div class="support-desc">
                            <h6>Giang hàng trên toàn quốc</h6>
                    ...
                    <div class="single-support">
                        ...
                        <div class="support-desc">
                            ...
                            <span>Sẵn sàng hỗ trợ người dùng mọi lúc, mọi nơi</span>
                        </div>
                    </div>
                </div>
            </div>
                         ...
                         <div class="col-xl-7 col-lg-7 ml-auto mr-auto col-md-8">
                            <div class="news-desc text-center mb-30">
                             ...
                             <div class="newsletter-box">
                                 <form action="#">
                                      <input class="subscribe" placeholder="Nhập địa chỉ mail của bạn" name="email" id="subscribe" type="text">
                            ...
                            <div class="single-footer mb-sm-40">
                                ...
                                <div class="footer-content">
                                    <ul class="footer-list">
                                        ...
                                        <li><a href="contact.php">Điều khoản và điều kiện</a></li>
                                        <li><a href="login.php">Câu hỏi thường gặp</a></li>
                                        <li><a href="login.php">Chính sách hoàn trả</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="single-footer mb-sm-40">
                                ...
                                <div class="footer-content">
                                    <ul class="footer-list address-content">
                                        <li><i class="lnr lnr-map-marker"></i> Địa chỉ: 273 An Dương Vương, phường 4, quận 5, thành phố Hồ Chí Minh</li>
                                        <li><i class="lnr lnr-envelope"></i><a href="#">Mail: Support@sgu.edu.vn</a></li>
                                        <li>
                                            <i class="lnr lnr-phone-handset"></i> Số điện thoại: (+800) 123 456 789)
                                        </li>
                                    </ul>
