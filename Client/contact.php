...
<head>
    ...
    <title>Liên hệ với chúng tôi | Web C2C</title>
       ...
       <?php
        ...
        <div class="contact-area ptb-100 ptb-sm-60">
            <div class="container">
                ...
                <p class="text-capitalize mb-20">Chúng tôi cảm ơn những góp ý của bạn . Chúng tôi sẽ phản hồi cho bạn nhanh nhất có thể!</p>
                <form id="contact-form" class="contact-form" action="mail.php" method="post">
                    <div class="address-wrapper row">
                        ...
                        <div class="col-md-6">
                            <div class="address-web">
                                <input class="form-control" type="text" name="website" placeholder="Trang bạn muốn góp ý ..">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="address-subject">
                                <input class="form-control" type="text" name="subject" placeholder="Bạn gặp phải vấn đề gì ..">
                            </div>
                        </div>
                        <div class="col-md-12">
                    ...
                    <div class="footer-content mail-content clearfix">
                        <div class="send-email float-md-right">
                            <input value="Gửi góp ý" class="return-customer-btn" type="submit">
                        </div>
                    </div>
                </form>
            </div>
