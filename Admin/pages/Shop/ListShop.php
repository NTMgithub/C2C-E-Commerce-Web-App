                        ...
                        <div class="table-data__tool-right">
                            <a href="<?php if (isset($_GET['action']) && ($_GET['action'] == 'add')) {
                                ...
                                <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                    <i class="zmdi zmdi-plus"></i>Thêm cửa hàng
                                </button>
                            </a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="tr-shadow">
                                        <td><?php echo $stt; ?></td>
                                        <td>
                                            <img src="uploads/shop/<?php echo $value['anhShop']; ?>" alt="avatarUser" style="width: 150px;height: 100px;">
                                        </td>
                                        <td><?php echo $value['tenShop']; ?></td>

                                        <td><?php echo $value['tenTaiKhoan']; ?></td>
                                        
                                        <td class="desc"><?php echo $value['diaChiShop']; ?></td>
                                        <td><?php echo $value['moTaShop']; ?></td>
                                        <td><?php if ($value['diemDanhGia'] == NULL) echo "0"; ?></td>
                                        ...
                                        <td>
                                            <div class="table-data-feature">
                                                <a href="?viewpage=list-shop&action=edit&idShop=<?php echo $value['id_shop']; ?>" onclick="return popitup('?viewpage=list-shop&action=edit&idShop=<?php echo $value['id_shop']; ?>')">
                                                ...
                                                if ($value['trangThai']  == 1) {
                                                    ...
                                                    data-toggle='modal' data-target='#LockUnlockModal" . $value['id_shop'] . "' ><i class='fa fa-lock'></i></button>";
                                                    echo $lockButton;
                                                } else {
                                                    $unlockButton = "<button type='button' class='btn btn-warning' style='margin: 5px;' data-placement='top' title='Mở khóa tài khoản'
                                                    data-toggle='modal' data-target='#LockUnlockModal" . $value['id_shop'] . "' ><i class='fa fa-unlock'></i></button>";
                                                    echo $unlockButton;
                                                }
                                                ?>
                                ...
                                <?php
                                    ...
                                    include('LockUnlockShopModal.php');
